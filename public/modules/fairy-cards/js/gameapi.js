...
fg_api.prototype.navigationModule = function() {
    ...
    module.prototype.init = function() {
        ...
        if (self.hasFeature('menu')) {
            console.log("prevent left hand menu");
...
fg_api.prototype.firebaseModule = function() {
    ...
    module.prototype.initializeFirebase = function() {
        ...
        M.promise = new Promise(function(resolve, reject) {
            ...
            console.warn("prevent firebase libaries");
            reject('Firebase App not ready');
            return;
            faZepto.getScript('https://www.gstatic.com/firebasejs/5.9.2/firebase-app.js', function() {
                faZepto.getScript('https://www.gstatic.com/firebasejs/5.9.2/firebase-database.js', function() {
                    // Initialize Firebase
                    var config = {
...
fg_api.prototype.geoModule = function() {
    ...
    module.prototype.init = function() {
        M.promise = new Promise(function(resolve, reject) {
            ...
            faZepto.extend(M.geodata, {"countryCode":"HK"});
            resolve(M.geodata);
